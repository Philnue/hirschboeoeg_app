...
class AddPollAndroid extends StatefulWidget {
  const AddPollAndroid({Key? key}) : super(key: key);
  static const routeName = '/addPoll';

  @override
  State<AddPollAndroid> createState() => _AddPollAndroidState();
}

class _AddPollAndroidState extends State<AddPollAndroid> {
